...
There are two stages, each with ONE view here: `phenology` and `growth` (yield).
The Germany-wide project this was derived from had a second growth view (`lai` and
